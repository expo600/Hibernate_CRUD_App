...
public class JdbcUtils {
    ...
    public static final String DEVELOPER_UPDATE =
            "UPDATE developers_database.developers SET first_name = '%s', last_name = '%s', specialty_id = %d, status_name = '%s' WHERE id = %d ;";


    public static final String DEVELOPER_DELETE_SKILLS =
            "DELETE FROM developers_database.developer_skills WHERE developer_id = %d ;";
